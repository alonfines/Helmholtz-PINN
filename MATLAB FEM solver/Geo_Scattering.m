...
Omega   = [3 4 0 4 4 0 2 2 0 0];        % Rectangular domain
Antenna = [1 1.5 0.7 0.005 zeros(1,6)]; % Small circle for source term 
Obst    = [1 3 1 0.2 zeros(1,6)];       % Circle for obstacle


%% ---------- Define the computational domainand build the mesh
Domain = [Omega; Antenna; Obst]';
ns     = (char('R','C1','C2'))'; % Names of objects
sf     = 'R-C1-C2';              % Omega minus the source and the obstacle (hole)
...
% --> Here: apply 1.5 on Antenna (edges 5 to 8), ABC on Omega (edges 1 to
% 4), hom Dir cond on obstacle.
